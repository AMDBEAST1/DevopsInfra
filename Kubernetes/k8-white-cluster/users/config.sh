...
# ------------------------------------------- #
clustername=k8-white
name=admin-amd
ns=kube-system # namespace
server=https://10.1.100.131:6443
crb=true # clusterrolebinding
crb_name=cluster-$name-binding # clusterrolebindingname_name
rb=false # rolebinding
rb_name=some_binding # rolebinding_name
# ------------------------------------------- #
# Creating Clusterrolebindings
kubectl create clusterrole cluster-$name --verb='*' --resource='*'
kubectl create clusterrolebinding cluster-$name-binding --clusterrole=cluster-$name --group=cluster-admin

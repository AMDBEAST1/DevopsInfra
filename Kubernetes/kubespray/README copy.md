...
declare -a IPS=(10.1.10.152 10.1.10.130 10.1.10.105 10.1.10.67 10.1.10.138 10.1.10.111)
...
# Without --become the playbook will fail to run!
python3 -m ansible playbook -i inventory/mycluster/hosts.yaml --private-key  ~/.ssh/id_rsa -u ansible --become --become-user=root cluster.yml
```
